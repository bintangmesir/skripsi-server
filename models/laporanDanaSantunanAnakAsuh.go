...
type LaporanDanaSantunanAnakAsuh struct {
	LaporanDanaSantunanAnakAsuhId string         `gorm:"primaryKey;unique;size:10" json:"laporan_dana_santunan_id"`
	...
	DanaSantunanAnakAsuh []DanaSantunanAnakAsuh `gorm:"foreignKey:LaporanDanaSantunanAnakAsuhId;constraint:OnUpdate:CASCADE,OnDelete:SET NULL" json:"dana_santunan_anak_asuh"`
}
